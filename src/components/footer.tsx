...
function Footer() {
  return (
    <div className="flex flex-col bg-back pb-[2rem]  z-50 relative h-full w-full gap-[7rem] pl-8 pr-5">
      ...
      <div className="flex flex-col md:flex-row mt-4 md:items-center justify-start w-max md:w-auto   md:justify-between">
        <svg
          width="72"
          height="30"
          viewBox="0 0 72 30"
        ...
        <p className="text-[#9a9595] flex  flex-row justify-start items-center">© ochi design 2024. <Links name="Leagal Terms" /></p>
        <p className="text-[#9a9595] flex  flex-row justify-start items-center">website by<Links name="AULAKH"/></p>
      </div>
    </div>
  );
}
